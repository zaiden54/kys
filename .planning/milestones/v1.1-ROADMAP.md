...
- [x] **Phase 8: Visual Redesign, Accessibility & PWA Safe-Area** - Full visual redesign, consistent money formatting, empty/error/loading states, confirmation dialogs, dark mode, accessibility basics, and Dynamic Island-safe layout (completed 2026-09-03)
...
- [x] 07-02-PLAN.md — E2E-02 bonus add/edit/delete + forecast-update coverage
- [x] 07-03-PLAN.md — E2E-03 vacation add/edit/delete + overlap validation + отпускные coverage
- [x] 07-04-PLAN.md — E2E-04 annual pie-chart + PWA manifest/install-banner coverage
...
- [x] 08-01-PLAN.md — Tracer: design-token system (globals.css) + shared (app) shell (nav/safe-area) + home screen end-to-end (page, hero card, install/YTD banners, error boundary, pie chart, new skeleton-loader component)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 08-02-PLAN.md — Bonuses screen restyle (bonus-row, bonus-form, bonuses/page) + Suspense loading skeleton
- [x] 08-03-PLAN.md — Vacations screen restyle (vacation-row, vacation-form, vacations/page) + Suspense loading skeleton
- [x] 08-04-PLAN.md — Salary/onboarding restyle (shared pay-setup-forms.tsx confirmation panel, settings/salary/page, onboarding/page)
- [x] 08-05-PLAN.md — Auth screens restyle (login/page, register/page)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 08-06-PLAN.md — Whole-phase regression (full unit + build + E2E suite) + end-of-phase human verification (Dynamic Island safe-area, dark/light toggle, keyboard focus pass, UI-SPEC backstop states)
...
| 8. Visual Redesign, Accessibility & PWA Safe-Area | v1.1 | 7/7 | Complete    | 2026-09-03 |
